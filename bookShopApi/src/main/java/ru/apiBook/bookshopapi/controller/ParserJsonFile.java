...
public class ParserJsonFile {
    ...
    public Root parseJson(){
        ...
        try(FileReader fileReader = new FileReader("data.json")){return fileGson.fromJson(fileReader, Root.class);}
    ...
    public void toJson(Root root){
        ...
        try(FileWriter fileWriter = new FileWriter("data.json")){fileGson.toJson(root, fileWriter);}
